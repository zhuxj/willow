var regexEnum =
{
    ...
    zipcode:"^\\d{6}$",//邮编
    mobile :"^((\\(\\d{3}\\))|(\\d{3}\\-))?13[0-9]\\d{8}|15[89]\\d{8}|18[89]\\d{8}$",//手机
...
function newBookIsbnCheck(isbn) {
    return isIsbn(isbn, false);
}

function sampleBookIsbnCheck(isbn) {
...
function companyIdCheck(companyId) {
    if (typeof(companyId) == "undefined" || companyId.trim() == "") {
        return "请选择商家!";
    }
    return true;
}