	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/skins/default/images/progressbar/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/skins/default/images/progressbar/progressbg_red.gif',
									30: '/skins/default/images/progressbar/progressbg_orange.gif',
									70: '/skins/default/images/progressbar/progressbg_green.gif'
								},
