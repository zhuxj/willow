...
<head>
    <title>更新产品分类</title>
    <script type="text/javascript" src="${resourceRoot}/door/admin/js/productcatalog/update.js"></script>
</head>
<body>
    ...
    <div class="formlist">
        <table>
            ...
            <tr>
                <th></th>
                <td>
                    <span class="btn btn01" id="updateProductCatalog"><a href="javascript:void(0)"><b>保存</b></a></span>
