...
CREATE TABLE website (
  ...
  website_name_en varchar(200) DEFAULT NULL COMMENT '商城英文名称',
  website_title_en varchar(100) DEFAULT NULL COMMENT '商城英文标题',
  website_desc_en varchar(500) DEFAULT NULL COMMENT '商城英文描述',
  logo_image_id char(36) DEFAULT NULL COMMENT '网站Logo图片ID',
  website_keyword varchar(200) DEFAULT NULL COMMENT '商城关键字',
  website_keyword_en varchar(200) DEFAULT NULL COMMENT '商城英文关键字',
