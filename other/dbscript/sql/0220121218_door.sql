...
CREATE TABLE t_door_product (
  ...
  update_time varchar(14) COMMENT '更新时间',
  user_id varchar(36) COMMENT '操作人',
  product_sn varchar(30) NOT NULL comment '产品编号',
  product_name varchar(50) NOT NULL comment '产品中文名称',
  product_name_en varchar(50) NOT NULL comment '产品英文名称',
  product_norms varchar(50) NOT NULL comment '产品中文规格',
  product_norms_en varchar(50) NOT NULL comment '产品英文规格',
  product_version varchar(50) NOT NULL comment '产品型号',
...
CREATE TABLE t_door_article (
  ...
  update_time varchar(14) COMMENT '更新时间',
  user_id varchar(36) COMMENT '操作人',
  article_code varchar(50) NOT NULL COMMENT '文章编码',
  article_title varchar(50) NOT NULL COMMENT '文章中文标题',
  article_title_sn varchar(50) NOT NULL COMMENT '文章英文标题',
  article_content text NOT NULL COMMENT '文章中文内容',
  article_content_en text NOT NULL COMMENT '文章英文内容',
