...
import com.willow.platform.codegen.db.DataSourceFactory;
import com.willow.platform.codegen.db.JdbcTypeNameTranslator;
import com.willow.platform.codegen.model.FieldColumn;
...
public class TableClassManager {
    ...
    public TableClass getTableClass(TableClass tableClass) throws Exception {
        if (tableClass == null) {
            throw new WillowException("tableClass can not be null");
        }
