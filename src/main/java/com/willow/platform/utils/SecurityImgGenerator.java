/**
 * @(#)com.willow.util.SecurityImgGenerator
 * 2009-7-14
 * Copyright 2009 
 * 软件公司, 版权所有 违者必究
 */
 ...
 * @version 1.0
 */
public class SecurityImgGenerator {
    private final Random random = new Random();

    private StringBuffer sRand = null;
    private StringBuffer sgbRand = null;
     ...
     * @return codeNumber
     */
    public final String image(HttpServletResponse response) {
     ...
     * @return codeNumber
     */
    public final String flushImage(HttpServletResponse response, BufferedImage image) {
        response.setHeader("Pragma", "No-cache");
        response.setHeader("Cache-Control", "no-cache");
        response.setDateHeader("Expires", 0);
        response.setContentType("image/jpeg");
