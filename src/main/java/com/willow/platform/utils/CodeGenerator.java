...
//        System.out.println(getRandomPassword());
        ...
        for (int i= 0;i< 10; i++) {
            Thread.sleep(2000);
            System.out.println("test:1"+getSHADigest("SEPU!PWO@LVE&045#67$appKeytestKeyauthor好书作者bookId9D55347F-37F0-4602-BE3C-F4F2B834F8EAbookName感動，如此創造companyId27630C20-B936-47B8-A4EA-8161BC5E76B5format1isbn9789861733807localusmethodbop.combook.updatemsgFormatxmlprice24000sessionIdD6611E38-FFBB-4ABF-B23F-61FA53CFDE99v1.0SEPU!PWO@LVE&045#67$"));
        }
    }
